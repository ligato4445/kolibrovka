...
def parse_args(argv):
    ...
    parser.add_argument("--gcode", default=base_dir / "gcode" / "golova.gcode")
    parser.add_argument("--image", default=base_dir / "photo" / "golova1.jpg")
    parser.add_argument("--calibration", default=base_dir / "calibration.json")
